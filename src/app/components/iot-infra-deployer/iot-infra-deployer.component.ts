...
export class IotInfraDeployerComponent implements OnInit {
  ...
  createForm() {
    ...
    this.deployerForm = this.formBuilder.group({
      ...
      deployerURL: ['http://34.232.71.154:3090/v1', Validators.required],
      deployConstraints: ['', Validators.required],
      gatewayId: ['', Validators.required],
      gatewayDescription: ['', Validators.required],
      gatewayHostname: ['', Validators.required],
      gatewayRouter: ['http://34.232.71.154:3090/v1', Validators.required],
      gatewayRouterPort: ['22', Validators.required],
      gatewayDeployNetwork: ['', Validators.required],
      gatewayLatitude: ['33.306340', Validators.required],
      gatewayLongitude: ['-111.934330', Validators.required],
      gatewayAccessToken: ['', Validators.required],
      ...
      airMqttHosname: ['', Validators.required],
      ...
      airMqttDataMetadataPublisher: ['Ubuntu18_IoTEdgexDataMetadataClient', Validators.required],
      ...
      edgeMqttZmqToMqttPublisher: ['Ubuntu18_IoTEdgeZMQToMQTTClient', Validators.required],
    });
