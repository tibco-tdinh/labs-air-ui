...
export const environment = {
  production: false,
  dgraphUrl: 'http://a4a5c370ea2df4b8ebded1fe988fe6c7-1806121577.us-west-2.elb.amazonaws.com/dgraph-alpha-http',
  dgraphBasicAuthEnabled: true,
  dgraphBasicAuth: 'Basic YWRtaW46YWRtaW4=',
  f1EndpointUrl: 'http://localhost:5408',
  // f1EndpointUrl: 'http://192.168.1.82:5408',
  ...
  airEndpointUrl: 'http://a4a5c370ea2df4b8ebded1fe988fe6c7-1806121577.us-west-2.elb.amazonaws.com',
  lightcraneEndpointUrl: 'http://localhost:5408',
  // lightcraneEndpointUrl: 'http://192.168.1.82:5408',
